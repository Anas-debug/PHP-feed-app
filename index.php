...
<img src="/php-crash/feedback/img/feedback-app.png" class="w-25 mb-3" alt="" style="border-radius:50%; width: 50px;">
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for Anas Saoui</p>
